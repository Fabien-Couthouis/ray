...
from ray.rllib.agents.cql.cql_tf_policy_dqn import CQLDQNTFPolicy
...
class CQLDQNTrainer(DQNTrainer):
    ...
    def validate_config(self, config: TrainerConfigDict) -> None:
        ...
        if config["variant"] not in ["sac", "dqn"]:
            raise ValueError(f"`variant` {config['variant']} is not supported for CQL! Only 'sac' or 'dqn' is supported.")
