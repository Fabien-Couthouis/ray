...
from ray.rllib.agents.sac.sac_tf_policy import (
    ...
    _get_dist_class as sac_get_dist_class,
    build_sac_model,
    postprocess_trajectory as sac_postprocess_trajectory,
    setup_late_mixins  as sac_setup_late_mixins,
    stats as sac_stats,
    validate_spaces as sac_validate_spaces,
...
from ray.rllib.agents.dqn.dqn_tf_policy import (
    ...
    postprocess_nstep_and_prio as dqn_postprocess_nstep_and_prio,
...
def cql_loss(
    ...
    action_dist_class = sac_get_dist_class(policy, policy.config, policy.action_space)
...
def build_model(
    ...
    if isinstance(action_space, Discrete):
        # Discrete actions: use CQL-DQN version
        return build_q_model 
    else:
        # Continuous actions: use CQL-SAC version
        return build_sac_model
