...
import ray
from ray.rllib.agents.cql.cql_dqn import CQL_DQN_DEFAULT_CONFIG, CQLDQNTrainer
...
class TestCQL(unittest.TestCase):
    ...
    def test_cql_compilation(self):
        ...
        config = CQL_DQN_DEFAULT_CONFIG.copy()
        config["n_step"] = 3
        config["model"] = {"fcnet_hiddens": [256], "fcnet_activation": "linear"}
        ...
        for fw in ["tf"]:
            trainer = CQLDQNTrainer(config=config)
...
if __name__ == "__main__":
    ...
    TestCQL("test_cql_compilation").test_cql_compilation()
